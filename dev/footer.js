...
ModAPI.addAPICallback("RecipeViewer", function(api){
    ...
    for(let i = 1; i <= ElementRegistry.maxAtomicNumber; i++){
        RV.addList(ItemID.chem_element, i, "item");
    }

    Callback.addCallback("LevelLoaded", function(){
        RV.list.splice(RV.list.findIndex(function(item){
            return item.id === ItemID.chem_element && item.data === -1;
        }), 1);
    });
    ...
    RV.registerRecipeType("chemical_decomposer", {
        contents: {
            ...
            elements: {
                input0: {type: "slot", x: 440, y: 0, size: 120},
                output0: {type: "slot", x: 200, y: 270, size: 120},
                output1: {type: "slot", x: 320, y: 270, size: 120},
                output2: {type: "slot", x: 440, y: 270, size: 120},
                output3: {type: "slot", x: 560, y: 270, size: 120},
                output4: {type: "slot", x: 680, y: 270, size: 120},
                output5: {type: "slot", x: 200, y: 390, size: 120},
                output6: {type: "slot", x: 320, y: 390, size: 120},
                output7: {type: "slot", x: 440, y: 390, size: 120},
                output8: {type: "slot", x: 560, y: 390, size: 120},
                output9: {type: "slot", x: 680, y: 390, size: 120},
    ...
    RV.registerRecipeType("chemical_synthesiser", {
        contents: {
            ...
            elements: {
                input0: {type: "slot", x: 200, y: 0, size: 120},
                input1: {type: "slot", x: 320, y: 0, size: 120},
                input2: {type: "slot", x: 440, y: 0, size: 120},
                input3: {type: "slot", x: 200, y: 120, size: 120},
                input4: {type: "slot", x: 320, y: 120, size: 120},
                input5: {type: "slot", x: 440, y: 120, size: 120},
                input6: {type: "slot", x: 200, y: 240, size: 120},
                input7: {type: "slot", x: 320, y: 240, size: 120},
                input8: {type: "slot", x: 440, y: 240, size: 120},
                output0: {type: "slot", x: 680, y: 120, size: 120}
            }
        },
        getList: function(id, data, isUsage){
    ...
    RV.registerRecipeType("chemical_fission", {
        contents: {
            icon: BlockID.fission_controller,
            description: "fission",
            params: {slot: "_default_slot_light"},
            drawing: [
            ...
            elements: {
                input0: {type: "slot", x: 220, y: 120, size: 120},
                output0: {type: "slot", x: 540, y: 120, size: 120},
                output1: {type: "slot", x: 660, y: 120, size: 120}
            }
        },
        getList: function(id, data, isUsage){
    ...
    RV.registerRecipeType("chemical_fusion", {
        contents: {
            icon: BlockID.fusion_controller,
            description: "fusion",
            params: {slot: "_default_slot_light"},
            drawing: [
            ...
            elements: {
                input0: {type: "slot", x: 220, y: 120, size: 120},
                input1: {type: "slot", x: 340, y: 120, size: 120},
                output0: {type: "slot", x: 660, y: 120, size: 120}
            }
        },
        getList: function(id, data, isUsage){
            if(id !== ItemID.chem_element){
